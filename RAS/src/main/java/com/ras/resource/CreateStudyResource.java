...
public class CreateStudyResource {
	...
	public List<LabelDetails> addUserRequest(@RequestBody CreateStudy createStudy) {
		...
		List<LabelDetails> returnValue = createStudyService.addCreateStudyDefaultValues(createStudy);
